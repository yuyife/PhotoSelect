package com.yuyife.photoselect.adapters;
...
import com.yuyife.photoselect.PhotoPickerActivity;
import com.yuyife.photoselect.R;
import com.yuyife.photoselect.beans.Photo;
import com.yuyife.photoselect.utils.OtherUtils;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_CAMERA) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.photo_item_camera_layout, null);
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(
                        R.layout.photo_item_photo_layout, null);
            ...
            holder.photoImageView.setImageResource(R.drawable.photo_ic_photo_loading);
